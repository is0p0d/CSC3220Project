...
#attach(studentData_df)
#bindTable <- table(Depressed, STEM)
#barplot((bindTable['Freq']/bindTable['Depressed']), horiz=TRUE, xlab = "Number of Students", ylab = "Are you Depressed?", legend.text = TRUE )
#detach(studentData_df)
```
...
#binnedGPA_df = studentData_df.filter('GPA', 'Depressed', axis=1)
#pander(binnedGPA_df)
